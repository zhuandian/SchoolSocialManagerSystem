...
import com.zhuandian.schoolsocialmanagersystem.MainActivity;
import com.zhuandian.schoolsocialmanagersystem.R;
import com.zhuandian.schoolsocialmanagersystem.entity.UserEntity;
                ...
                public void done(UserEntity userEntity, BmobException e) {
                    if (e == null) {
                        if (userEntity.getRoleId() == 2) {
                            ...
                            Toast.makeText(LoginActivity.this, "抱歉，您不是管理员，无权登陆...", Toast.LENGTH_SHORT).show();
                        }
